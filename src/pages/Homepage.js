...
export default function Homepage() {
  ...
  {!company ? <Loading /> : <section className="showcase">
    <div className="overlay">
     ...
     max-w-4xl mx-auto mt-10 lg:gap-20 px-5">
     <article>
        <h2 className="font-bold border-b-2 border-white text-xl 
        mb-3 pb-2 uppercase tracking-wider">About</h2>
      <ul className="text-sm opacity-75">
        ...
        <li className="mb-1">is valued at {company.valuation.toLocaleString()}B</li>
     ...
     <article>
        <h2 className="font-bold border-b-2 border-white text-xl 
        mb-3 pb-2 uppercase tracking-wider">Headquarters</h2>
      <ul className="text-sm opacity-75">
      ...
      <article>
        <h2 className="font-bold border-b-2 border-white text-xl 
        mb-3 pb-2 uppercase tracking-wider">Useful Links</h2>
      <ul className="text-sm opacity-75">
        ...
        <li className="mb-1"><a href={company.links.elon_twitter}>Elon_Twitter</a></li>
      ...
      <p className="max-w-3xl mx-auto text-center">{company.summary}</p>
      </article>
